...
def prepare_sequences(notes, n_vocab):
    ...
    network_output = to_categorical(network_output, num_classes=n_vocab)  # One-hot encode the output
...
def create_network(network_input, n_vocab):
    ...
    # Attempt to load weights with error handling
    try:
...
def train(model, network_input, network_output):
    ...
    filepath = "updated-lofi-hip-hop-weights-improvement-{epoch:02d}-{loss:.4f}.keras"
